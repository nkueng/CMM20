...
bool SQPMinimizer::minimize(ConstrainedObjectiveFunction *function, dVector &p)
{
    ...
    for (i = 0; i < maxIterations_; i++) {
        ...
        // DEBUG
        // std::cout << "The gradient is of size " << gradient.rows() << "x" << gradient.cols() << std::endl;
        ...
        // DEBUG
        // std::cout << "The hessian H is of size " << H.rows() << "x" << H.cols() << std::endl;
        // std::cout << H << std::endl;
        if (printOutput_)
        ...
        // DEBUG
        // std::cout << "The constraint matrix A is of size " << A.rows() << "x" << A.cols() << std::endl;
        // std::cout << A << std::endl;
        // std::cout << "The constraint matrix C is of size " << C.rows() << "x" << C.cols() << std::endl;
        // std::cout << C << std::endl;
        if (printOutput_)
